...
__help_filter() {
  ...
  echo -e "  ${GITTER_C____ERROR}author     ${GITTER_C____RESET}  [substr]   Match for author email"
  echo -e "  ${GITTER_C____ERROR}author-name${GITTER_C____RESET}  [substr]   Match for author name"
