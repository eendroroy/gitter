...
__help() {
  ...
  echo -e "  ${GITTER_C___OPTION}--processable       -p          ${GITTER_C____RESET} Produce processable output (no colors/symbols, simple formatting ${GITTER_C______ARG}<path>::<<OUT::stdout>|<ERR::stderr>>${GITTER_C____RESET})"
...
__help_status() {
  ...
  echo -e "    ${GITTER_C______ARG}branch${GITTER_C____RESET}            ${separator}${GITTER_C______ARG}[type]${GITTER_C____RESET}${separator}${GITTER_C______DIM} on ${GITTER_C____RESET}${separator}${GITTER_C______ARG}[branch]${GITTER_C____RESET}"
  echo -e "    ${GITTER_C______ARG}updated${GITTER_C____RESET}           ${separator}${GITTER_C______ARG}[type]${GITTER_C____RESET}${separator}${GITTER_C______DIM} on ${GITTER_C____RESET}${separator}${GITTER_C______ARG}[branch]${GITTER_C____RESET}${separator} ${separator}${GITTER_C______ARG}[time:r]${GITTER_C____RESET}"
  echo -e "    ${GITTER_C______ARG}updated-at${GITTER_C____RESET}        ${separator}${GITTER_C______ARG}[type]${GITTER_C____RESET}${separator}${GITTER_C______DIM} on ${GITTER_C____RESET}${separator}${GITTER_C______ARG}[branch]${GITTER_C____RESET}${separator} ${separator}${GITTER_C______ARG}[commit:8]${GITTER_C____RESET}${separator}${GITTER_C______DIM} at ${GITTER_C____RESET}${separator}${GITTER_C______ARG}[time:d]${GITTER_C____RESET}"
  echo -e "    ${GITTER_C______ARG}updated-by${GITTER_C____RESET}        ${separator}${GITTER_C______ARG}[type]${GITTER_C____RESET}${separator}${GITTER_C______DIM} on ${GITTER_C____RESET}${separator}${GITTER_C______ARG}[branch]${GITTER_C____RESET}${separator} ${separator}${GITTER_C______ARG}[commit:8]${GITTER_C____RESET}${separator}${GITTER_C______DIM} by ${GITTER_C____RESET}${separator}${GITTER_C______ARG}[author:e]${GITTER_C____RESET}${separator} ${GITTER_C______ARG}[time:r]${GITTER_C____RESET}"
  echo -e "    ${GITTER_C______ARG}updated-by-at${GITTER_C____RESET}     ${separator}${GITTER_C______ARG}[type]${GITTER_C____RESET}${separator}${GITTER_C______DIM} on ${GITTER_C____RESET}${separator}${GITTER_C______ARG}[branch]${GITTER_C____RESET}${separator} ${separator}${GITTER_C______ARG}[commit:8]${GITTER_C____RESET}${separator}${GITTER_C______DIM} by ${GITTER_C____RESET}${separator}${GITTER_C______ARG}[author:e]${GITTER_C____RESET}${separator} ${GITTER_C______DIM}at${GITTER_C____RESET} ${separator}${GITTER_C______ARG}[time:d]${GITTER_C____RESET}"
