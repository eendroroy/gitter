...
__help() {
  ...
  echo -ne " [${GITTER_C__OPTION}git${GITTER_C___RESET}|${GITTER_C__OPTION}exec${GITTER_C___RESET}|${GITTER_C__OPTION}list${GITTER_C___RESET}|${GITTER_C__OPTION}help${GITTER_C___RESET}]"
  echo -e " [${GITTER_C__OPTION}--${GITTER_C___RESET} <${GITTER_C____ARGS}args ...${GITTER_C___RESET}>]"
  echo
  ...
  echo
  echo -e "  Prefixes:"
  echo -e "    ${GITTER_C___ERROR}path  ${GITTER_C___RESET} ${GITTER_C___ERROR}P${GITTER_C___RESET}   Match for path name"
  echo -e "    ${GITTER_C___ERROR}repo  ${GITTER_C___RESET} ${GITTER_C___ERROR}R${GITTER_C___RESET}   Match for repo name"
  echo -e "    ${GITTER_C___ERROR}branch${GITTER_C___RESET} ${GITTER_C___ERROR}B${GITTER_C___RESET}   Match for current git branch"
  echo
  echo -e "  Patterns:"
